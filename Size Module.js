const dangerlist = [
  ...
  function Scanner() {
      if (document.querySelector("#react-root > div > div:nth-child(4) > div > div > section > div.introduction-right > div.container-card.accountSettingsBox > div:nth-child(9) > div.content-item.full-sync > span").innerText == "Full Sync:") {
        ...
        document.querySelector("#react-root > div > div:nth-child(4) > div > div > section > div.introduction-right > div.container-card.accountSettingsBox > div:nth-child(9) > div.content-item.full-sync > span").style.backgroundColor = "red";
        document.querySelector("#react-root > div > div:nth-child(4) > div > div > section > div.introduction-right > div.container-card.accountSettingsBox > div:nth-child(9) > div.content-item.full-sync > div").style.backgroundColor = "red";
...
//Probs to Andrew for a codereview/edit!
